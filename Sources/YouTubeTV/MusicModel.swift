...
final class MusicModel {
    ...
    func handle(_ intent: NavigationIntent) {
        ...
        // Rows are carousels/shelves like browse — Tab walks a row the same
        // way an arrow key does. See MusicNavigator's file-level doc comment.
        let intent = intent.asMove(horizontal: true)
        ...
        case .tab: break   // reduced to .move above
        case .text: break
        }
    }
